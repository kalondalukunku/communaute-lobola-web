...
<body>
    ...
    <div class="card">
        ...
        <!-- Corps -->
        <div class="content">
            <p class="greeting">Bonjour cher <strong><?= $user->nom_role ?></strong>,</p>
            <p class="description">
                Nous vous confirmons que votre compte sur la plateforme de gestion des personnels <?= SITE_NAME; ?> a été activé avec succès. <br>
                Vous pouvez désormais vous connecter et accéder à votre espace personnel pour gérer les personnels selon votre rôle.
            </p>

            <div class="cta-container">
                <a href="<?= $lien_connexion ?>" class="btn-primary">
                    Se connecter
                </a>
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <span class="role-badge"><?= $user->nom_role ?></span>
                </div>
            </div>
