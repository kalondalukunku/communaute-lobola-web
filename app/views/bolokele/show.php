        ...
        <?php if ($isOn): ?>
            ...
            <?php if($Series[0]->nom_serie === "Mâat • Introduction & Préparation"): ?>
                <div class="w-[80%] mx-auto mt-12 mb-20">
                    ...
                    <div class="lg:col-span-5 bg-[##130121] color-border rounded-[2rem] p-6 md:p-8 shadow-2xl relative overflow-hidden">
            ...
            <?php if($Series[0]->nom_serie === "Mâat • Module 1 : Religions & Spiritualités"): ?>
                <div class="w-[80%] mx-auto mt-12 mb-20">
                    ...
                    <div class="lg:col-span-7 bg-[##130121] color-border rounded-[2rem] p-6 md:p-8 shadow-2xl relative overflow-hidden">
