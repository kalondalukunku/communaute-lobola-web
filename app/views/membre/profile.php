                    ...
                    <div class="relative z-10">
                        ...
                        <?php endif; ?>
                            <form action="" method="POST" class="ml-6">
                                <button name="cllil_membre_expt_fiche" type="submit" class="group relative inline-flex mt-4 items-center justify-center px-10 py-4 font-bold text-paper transition-all duration-300 bg-primary rounded-full hover:shadow-[0_0_30px_rgba(var(--primary-rgb),0.4)] hover:-translate-y-1">
                                    <span class="relative z-10 flex items-center gap-2 uppercase text-xs">
                                        Imprimer ma fiche
                                        <i class="fas fa-edit text-[10px] group-hover:translate-x-1 transition-transform"></i>
                                    </span>
