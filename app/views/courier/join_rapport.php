        ...
        <div class="row mb-5">
            <main class="form-signin m-auto"> 
                <nav class="breadcrumb-custom mb-2">
                    ...
                    / <span class="text-secondary">Joindre le rapport</span>
                </nav>
                ...
                <form method="post" enctype="multipart/form-data"> 
                    ...
                    <button class="primary-btn w-100" name="bukus_courier_joindre_rapport" type="submit">Joindre le rapport</button> 
                </form> 
