<?php
    ...
    $title = $isSuccess ? 'Paiement confirmé' : 'Paiement échoué';
    $message = $isSuccess
        ? 'Votre paiement a été validé avec succès. Merci pour votre paiement.'
        : $transPayment['failureReason'] ?? 'Le paiement a échoué. Veuillez réessayer.';
    $buttonLabel = $isSuccess ? 'Télécharger le livre : '. $Livre->titre : 'Réessayer';
    $buttonHref = "show/$Livre->livre_id";
?>
